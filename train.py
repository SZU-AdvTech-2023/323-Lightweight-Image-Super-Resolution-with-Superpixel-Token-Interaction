...
parser.add_argument('--config', type=str, default='./configs/spin_light_x2.yml', help = 'pre-config file for training')
parser.add_argument('--resume', type=str, default='./experiments/None-spin-fp32-x2-2023-1119-0959', help = 'resume training or not')
    ...
    for epoch in range(start_epoch, args.epochs+1):
        ...
        if epoch % args.test_every == 0:
            ...
            for valid_dataloader in valid_dataloaders:
                ...
                stat_dict[name]['best_psnr']['value']=0
                stat_dict[name]['best_ssim']['value']=0
